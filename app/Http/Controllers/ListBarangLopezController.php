...
class ListBarangLopezController extends Controller
{
    public function getData()
    {
        ...
        $dataBarang = [
            ...
            ['id' => 1, 'nama' => 'Tepung Rosebrand', 'harga' => 10000],
            ['id' => 1, 'nama' => 'Sofell Anti Nyamuk', 'harga' => 3000],
            ['id' => 1, 'nama' => 'Masako', 'harga' => 5000],
            ['id' => 1, 'nama' => 'Minyak Goreng Sunco 1 Liter', 'harga' => 30000],
        ];
